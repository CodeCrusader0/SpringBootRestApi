...
//add REST end point to get all emps
	...
	@PostMapping
	public Student saveEmpDetails(@RequestBody Student transientEmp)
	{
	...
	@GetMapping("/{empId}")
	public Student getEmpDetails(@PathVariable Long empId)
	{
	...
	@PutMapping
	public Student updateEmpDetails(@RequestBody Student detachedEmp)
	{
	...
	@PostMapping("/signin")
	public Student validateEmployee(@RequestBody LoginRequestDto dto)
	{
